-- =========================================================
-- HYPE V10 - PORTARIA: QR -> DADOS -> CONFIRMAR ENTRADA
--          + ADMIN: LIMPEZA DEFINITIVA / BANCO ZERADO
...
-- 2) Limpeza DEFINITIVA de ingressos.
--    TRUNCATE ... CASCADE remove também registros auxiliares que tenham
--    chave estrangeira apontando para tickets (auditoria/pagamentos etc.).
--    Eventos, lotes e usuários não dependem de tickets e são preservados.
...
begin
  ...
  -- Zera os ingressos e qualquer tabela filha ligada a eles.
  -- RESTART IDENTITY deixa a base realmente limpa para a próxima festa.
...
-- 3) Garante que a validação existente encontre crypt().
